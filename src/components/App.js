...
class App extends React.Component {
    ...
    handleCardClick = (link) => {
        this.setState({ selectedCard: {isImagePopupOpen: true, CardLink: link} });
    }
    ...
    render() {
        return (
            <div className="body">
                ...
                <div className="page">
                    <Header />
                    <Main  onCardClick={this.handleCardClick} onEditAvatar={this.handleEditAvatarClick} onEditProfile={this.handleEditProfileClick} onAddPlace={this.handleAddPlaceClick} />
                    <Footer />
                </div>
