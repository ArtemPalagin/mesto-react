    ...
    render() {
        return (
            <div className="body">
                ...
                <div className="page">
                    <Header />
                    <Main onCard={this.handleCardClick} onEditAvatar={this.handleEditAvatarClick} onEditProfile={this.handleEditProfileClick} onAddPlace={this.handleAddPlaceClick} />
                    <Footer />
                </div>
